<template>
  <div class="chart-container">
    ...
    <div v-else-if="!hasValidData" class="flex flex-col items-center justify-center h-full text-gray-500 text-sm">
      <PresentationChartLineIcon class="h-12 w-12 mb-2 text-gray-400" />
...
const chartData = computed(() => {
  return {
    ...
    smooth: props.chart.properties.line?.smooth || false,
    fillArea: props.chart.properties.line?.fillArea || false
  }
})
