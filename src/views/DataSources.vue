            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                >
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span
                      v-if="dataSource.category"
                      class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                      :class="getCategoryColor(dataSource.category)"
                    >
                      {{ dataSource.category }}
                    </span>
                ...
                <div v-if="selectedDataSource">
                  <div class="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <div v-if="selectedDataSource.category" class="mt-2">
                        <span
                          class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                          :class="getCategoryColor(selectedDataSource.category)"
                        >
...
const filteredDataSources = computed(() => {
  ...
  return dataSourceStore.dataSources.filter(ds =>
    ...
    (ds.category && ds.category.toLowerCase().includes(query))
  )
})
